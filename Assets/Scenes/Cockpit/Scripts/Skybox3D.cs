...
#pragma warning disable CS0672
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            using (var builder = renderGraph.AddRasterRenderPass("3D Skybox", out _3DSkyboxPassData passData))
            {
                ...
                passData.isYFlipped = !cameraData.isActiveTargetBackBuffer;
        ...
        private void ExecuteRenderGraph( _3DSkyboxPassData passData, RasterGraphContext rgContext )
        {
            ...
            if (cameraData.xr.enabled && cameraData.xr.singlePassEnabled) //If skybox is rendering in VR, we have to modify matrices to eliminate unwanted parallax
            {
                ...
                XRBuiltinShaderConstants.UpdateBuiltinShaderConstants(centerView, leftEyeProjection, passData.isYFlipped, 0);
                XRBuiltinShaderConstants.UpdateBuiltinShaderConstants(centerView, rightEyeProjection, passData.isYFlipped, 1);
                ...
                XRBuiltinShaderConstants.UpdateBuiltinShaderConstants(leftEyeView, leftEyeProjection, passData.isYFlipped, 0);
                XRBuiltinShaderConstants.UpdateBuiltinShaderConstants(rightEyeView, rightEyeProjection, passData.isYFlipped, 1);
                XRBuiltinShaderConstants.SetBuiltinShaderConstants(cmd);
            }
            else
            {
